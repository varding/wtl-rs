...
pub trait MyCWin {
    ...
    fn display_hwnd(&self){
    	//println!("{},addr:0x{:x}", self.GetHwnd() as usize,Self::CenterWindow as usize);
    	//println!("{},addr:0x{:x}", self.GetHwnd() as usize,Self::GetParent as usize);
    }
	//all get functions
	...
	// }
    fn GetParent(&self) -> HWND {
        self.assert_window();
        unsafe{user32::GetParent(self.GetHwnd())}
    }

    fn SetParent(&self,hWndNewParent:HWND) -> HWND {
        self.assert_window();
        unsafe{user32::SetParent(self.GetHwnd(), hWndNewParent)}
    }

    fn GetDlgItem(&self,nID:c_int) -> HWND {
        self.assert_window();
        unsafe{user32::GetDlgItem(self.GetHwnd(), nID)}
    }

    
	//add rewritted functions of above that use cwindow as output,sometimes very convenient
    fn GetParent2(&self) -> HWND {
        self.assert_window();
        unsafe{user32::GetParent(self.GetHwnd())}
    }
    ...
    fn SetParent2(&self, hWndNewParent: HWND) -> CWindow {
        self.assert_window();
        CWindow::new(unsafe {
                user32::SetParent(self.GetHwnd(), hWndNewParent)
            })
    }
    ...
    fn GetDlgItem2(&self, nID: c_int) -> CWindow {
        self.assert_window();
        CWindow::new(unsafe {
                user32::GetDlgItem(self.GetHwnd(), nID)
            })
    }
	...
	*/
    ...
    fn Create(lpstrWndClass: LPCWSTR,
                  hWndParent: HWND,
                  // _U_RECT rect = NULL,
                  rect: &RECT,
    ...
    fn DestroyWindow(&mut self) -> BOOL {
        self.assert_window();
        unsafe{
            if user32::DestroyWindow(self.GetHwnd()) == TRUE {
                self.Detach();
                return TRUE;
            }
            FALSE
    ...
    fn GetStyle(&self) -> DWORD {
        self.assert_window();
        unsafe {
            user32::GetWindowLongW(self.GetHwnd(), GWL_STYLE) as DWORD
        }
    }
    ...
    fn GetExStyle(&self) -> DWORD {
        self.assert_window();
        unsafe {
            user32::GetWindowLongW(self.GetHwnd(), GWL_EXSTYLE) as DWORD
        }
    }
    ...
    fn GetWindowLong(&self, nIndex: c_int) -> LONG {
        self.assert_window();
        unsafe {
            user32::GetWindowLongW(self.GetHwnd(), nIndex)
        }
    }
    ...
    fn GetWindowLongPtr(&self, nIndex: c_int) -> LONG_PTR {
        self.assert_window();
        unsafe {
            user32::GetWindowLongPtrW(self.GetHwnd(), nIndex)
        }
    }
    ...
    fn SetWindowLong(&self, nIndex: c_int, dwNewLong: LONG) -> LONG {
        self.assert_window();
        unsafe {
            user32::SetWindowLongW(self.GetHwnd(), nIndex, dwNewLong)
        }
    }
    ...
    fn SetWindowLongPtr(&self, nIndex: c_int, dwNewLong: LONG_PTR) -> LONG_PTR {
        self.assert_window();
        unsafe {
            user32::SetWindowLongPtrW(self.GetHwnd(), nIndex, dwNewLong)
        }
    }
    ...
    fn GetWindowWord(&self, nIndex: c_int) -> WORD {
        self.assert_window();
        unsafe {
            user32::GetWindowWord(self.GetHwnd(), nIndex)
        }
    }
    ...
    fn SetWindowWord(&self, nIndex: c_int, wNewWord: WORD) -> WORD {
        self.assert_window();
        unsafe {
            user32::SetWindowWord(self.GetHwnd(), nIndex, wNewWord)
        }
    }
    ...
    fn SendMessage(&self, message: UINT, wParam: WPARAM, lParam: LPARAM) -> LRESULT {
        self.assert_window();
        unsafe {
            user32::SendMessageW(self.GetHwnd(), message, wParam, lParam)
        }
    }
    ...
    fn PostMessage(&self, message: UINT, wParam: WPARAM, lParam: LPARAM) -> bool {
        self.assert_window();
        unsafe {
            user32::PostMessageW(self.GetHwnd(), message, wParam, lParam) == TRUE
        }
    }
    ...
    fn SendNotifyMessage(&self, message: UINT, wParam: WPARAM, lParam: LPARAM) -> bool {
        self.assert_window();
        unsafe {
            user32::SendNotifyMessageW(self.GetHwnd(), message, wParam, lParam) == TRUE
        }
    }
    ...
    fn GetWindowTextLength(&self) -> c_int {
        self.assert_window();
        unsafe {
            user32::GetWindowTextLengthW(self.GetHwnd())
        }
    }
    ...
    fn SetFont(&self, hFont: HFONT, bRedraw: BOOL) {
        ...
        unsafe {
            user32::SendMessageW(self.GetHwnd(), WM_SETFONT, hFont as WPARAM, (bRedraw & 0xFFFF) as LPARAM);
        }
    }
    ...
    fn GetFont(&self) -> HFONT {
        self.assert_window();
        unsafe {
            user32::SendMessageW(self.GetHwnd(), WM_GETFONT, 0, 0)  as HFONT
        }
    }
    ...
    fn GetMenu(&self) -> HMENU {
        self.assert_window();
        unsafe {
            user32::GetMenu(self.GetHwnd()) as HMENU
        }
    }
    ...
    fn SetMenu(&self, hMenu: HMENU) -> bool {
        self.assert_window();
        unsafe {
            user32::SetMenu(self.GetHwnd(), hMenu) == TRUE
        }
    }
    ...
    fn DrawMenuBar(&self) -> bool {
        self.assert_window();
        unsafe {
            user32::DrawMenuBar(self.GetHwnd()) == TRUE
        }
    }
    ...
    fn IsIconic(&self) -> bool {
        self.assert_window();
        unsafe {
            user32::IsIconic(self.GetHwnd()) == TRUE
        }
    }
    ...
    fn IsZoomed(&self) -> bool {
        self.assert_window();
        unsafe {
            user32::IsZoomed(self.GetHwnd()) == TRUE
        }
    }
    ...
    fn MoveWindow(&self,
        ...
        self.assert_window();
        unsafe {
            user32::MoveWindow(self.GetHwnd(), x, y, nWidth, nHeight, bRepaint) == TRUE
        }
    }
    ...
    fn MoveWindow2(&self, lpRect: &RECT, bRepaint: BOOL) -> bool {
        self.assert_window();
        unsafe {
            user32::MoveWindow(self.GetHwnd(),
                               lpRect.left,
                               lpRect.top,
    ...
    fn SetWindowPos(&self,
        ...
        self.assert_window();
        unsafe {
            user32::SetWindowPos(self.GetHwnd(), hWndInsertAfter, x, y, cx, cy, nFlags) == TRUE
        }
    }
    ...
    fn SetWindowPos2(&self, hWndInsertAfter: HWND, lpRect: &RECT, nFlags: UINT) -> bool {
        self.assert_window();
        unsafe {
            user32::SetWindowPos(self.GetHwnd(),
                                 hWndInsertAfter,
                                 lpRect.left,
                                 lpRect.top,
                                 lpRect.right - lpRect.left,
    ...
    fn ArrangeIconicWindows(&self) -> UINT {
        self.assert_window();
        unsafe {
            user32::ArrangeIconicWindows(self.GetHwnd())
        }
    }
    ...
    fn BringWindowToTop(&self) -> bool {
        self.assert_window();
        unsafe {
            user32::BringWindowToTop(self.GetHwnd()) == TRUE
        }
    }
    ...
    fn GetWindowRect(&self, lpRect: LPRECT) -> bool {
        self.assert_window();
        unsafe {
            user32::GetWindowRect(self.GetHwnd(), lpRect) == TRUE
        }
    }
    ...
    fn GetClientRect(&self, lpRect: &mut RECT) -> bool {
        ...
        unsafe {
            user32::GetClientRect(self.GetHwnd(), p) == TRUE
        }
    }
    ...
    fn GetWindowPlacement(&self, lpwndpl: &mut WINDOWPLACEMENT) -> bool {
        self.assert_window();
        unsafe {
            user32::GetWindowPlacement(self.GetHwnd(), lpwndpl) == TRUE
        }
    }
    ...
    fn SetWindowPlacement(&self, lpwndpl: &WINDOWPLACEMENT) -> bool {
        self.assert_window();
        unsafe {
            user32::SetWindowPlacement(self.GetHwnd(), lpwndpl) == TRUE
        }
    }
    ...
    fn ClientToScreen(&self, lpPoint: LPPOINT) -> bool {
        self.assert_window();
        unsafe {
            user32::ClientToScreen(self.GetHwnd(), lpPoint) == TRUE
        }
    }
    ...
    fn ClientToScreen2(&self, lpRect: &mut RECT) -> bool {
        ...
        if unsafe {
            user32::ClientToScreen(self.GetHwnd(), p2)
        } == FALSE {
            return false;
        }
        unsafe {
            user32::ClientToScreen(self.GetHwnd(), p2.offset(1)) == TRUE
        }
    }
    ...
    fn ScreenToClient(&self, lpPoint: LPPOINT) -> bool {
        self.assert_window();
        unsafe {
            user32::ScreenToClient(self.GetHwnd(), lpPoint) == TRUE
        }
    }
    ...
    fn ScreenToClient2(&self, lpRect: &mut RECT) -> bool {
        ...
        if unsafe {
            user32::ScreenToClient(self.GetHwnd(), p2)
        } == FALSE {
            return false;
        }
		//user32::ScreenToClient(self.GetHwnd(), ((LPPOINT)lpRect)+1) == TRUE
        unsafe {
            user32::ScreenToClient(self.GetHwnd(), p2.offset(1)) == TRUE
        }
    }
    ...
    fn MapWindowPoints(&self, hWndTo: HWND, lpPoint: LPPOINT, nCount: UINT) -> c_int {
        self.assert_window();
        unsafe {
            user32::MapWindowPoints(self.GetHwnd(), hWndTo, lpPoint, nCount)
        }
    }
    ...
    fn MapWindowPoints2(&self, hWndTo: HWND, lpRect: LPRECT) -> c_int {
        ...
        unsafe {
            user32::MapWindowPoints(self.GetHwnd(), hWndTo, lpRect as LPPOINT, 2)
        }
    }
    ...
    fn BeginPaint(&self, lpPaint: LPPAINTSTRUCT) -> HDC {
        self.assert_window();
        unsafe {
            user32::BeginPaint(self.GetHwnd(), lpPaint)
        }
    }
    ...
    fn EndPaint(&self, lpPaint: LPPAINTSTRUCT) {
        self.assert_window();
        unsafe {
            user32::EndPaint(self.GetHwnd(), lpPaint);
        }
    }
    ...
    fn GetWindowDC(&self) -> HDC {
        self.assert_window();
        unsafe {
            user32::GetWindowDC(self.GetHwnd())
        }
    }
    ...
    fn ReleaseDC(&self, hDC: HDC) -> c_int {
        self.assert_window();
        unsafe {
            user32::ReleaseDC(self.GetHwnd(), hDC)
        }
    }
    ...
    fn Print(&self, hDC: HDC, dwFlags: DWORD) {
        self.assert_window();
        unsafe {
            user32::SendMessageW(self.GetHwnd(), WM_PRINT, hDC as WPARAM, dwFlags as LPARAM);
        }
    }
    ...
    fn PrintClient(&self, hDC: HDC, dwFlags: DWORD) {
        self.assert_window();
        unsafe {
            user32::SendMessageW(self.GetHwnd(), WM_PRINTCLIENT, hDC as WPARAM, dwFlags as LPARAM);
        }
    }
    ...
    fn UpdateWindow(&self) -> bool {
        self.assert_window();
        unsafe {
            user32::UpdateWindow(self.GetHwnd()) == TRUE
        }
    }
    ...
    fn SetRedraw(&self, bRedraw: BOOL) {
        self.assert_window();
        unsafe {
            user32::SendMessageW(self.GetHwnd(), WM_SETREDRAW, bRedraw as WPARAM, NULL_LPARAM);
        }
    }
    ...
    fn GetUpdateRect(&self, lpRect: LPRECT, bErase: BOOL) -> bool {
        self.assert_window();
        unsafe {
            user32::GetUpdateRect(self.GetHwnd(), lpRect, bErase) == TRUE
        }
    }
    ...
    fn GetUpdateRgn(&self, hRgn: HRGN, bErase: BOOL) -> c_int {
        self.assert_window();
        unsafe {
            user32::GetUpdateRgn(self.GetHwnd(), hRgn, bErase)
        }
    }
    ...
    fn Invalidate(&self, bErase: BOOL) -> bool {
        self.assert_window();
        unsafe {
            user32::InvalidateRect(self.GetHwnd(), 0 as LPRECT, bErase) == TRUE
        }
    }
    ...
    fn Invalidate2(&self, lpRect: LPCRECT, bErase: BOOL) -> bool {
        self.assert_window();
        unsafe {
            user32::InvalidateRect(self.GetHwnd(), lpRect, bErase) == TRUE
        }
    }
    ...
    fn ValidateRect(&self, lpRect: LPCRECT) -> bool {
        self.assert_window();
        unsafe {
            user32::ValidateRect(self.GetHwnd(), lpRect) == TRUE
        }
    }
    ...
    fn InvalidateRgn(&self, hRgn: HRGN, bErase: BOOL) {
        self.assert_window();
        unsafe {
            user32::InvalidateRgn(self.GetHwnd(), hRgn, bErase);
        }
    }
    ...
    fn ValidateRgn(&self, hRgn: HRGN) -> bool {
        self.assert_window();
        unsafe {
            user32::ValidateRgn(self.GetHwnd(), hRgn) == TRUE
        }
    }
    ...
    fn ShowWindow(&self, nCmdShow: c_int) -> bool {
        self.assert_window();
        unsafe {
            user32::ShowWindow(self.GetHwnd(), nCmdShow) == TRUE
        }
    }
    ...
    fn IsWindowVisible(&self) -> bool {
        self.assert_window();
        unsafe {
            user32::IsWindowVisible(self.GetHwnd()) == TRUE
        }
    }
    ...
    fn ShowOwnedPopups(&self, bShow: BOOL) -> bool {
        self.assert_window();
        unsafe {
            user32::ShowOwnedPopups(self.GetHwnd(), bShow) == TRUE
        }
    }
    ...
    fn GetDCEx(&self, hRgnClip: HRGN, flags: DWORD) -> HDC {
        self.assert_window();
        unsafe {
            user32::GetDCEx(self.GetHwnd(), hRgnClip, flags)
        }
    }
    ...
    fn LockWindowUpdate(&self, bLock: bool) -> bool {
        ...
        if bLock {
            unsafe {
                user32::LockWindowUpdate(self.GetHwnd()) == TRUE
            }
        } else {
            unsafe {
    ...
    fn RedrawWindow(&self, lpRectUpdate: LPCRECT, hRgnUpdate: HRGN, flags: UINT) -> bool {
        self.assert_window();
        unsafe {
            user32::RedrawWindow(self.GetHwnd(), lpRectUpdate, hRgnUpdate, flags) == TRUE
        }
    }
    ...
    fn SetTimer(&self, nIDEvent: UINT_PTR, nElapse: UINT) -> UINT_PTR {
        self.assert_window();
        unsafe {
            user32::SetTimer(self.GetHwnd(), nIDEvent, nElapse, None)
        }
    }
    ...
    fn SetTimer2(&self, nIDEvent: UINT_PTR, nElapse: UINT, lpfnTimer: TimerProc) -> UINT_PTR {
        self.assert_window();
        unsafe {
            user32::SetTimer(self.GetHwnd(), nIDEvent, nElapse, lpfnTimer)
        }
    }
    ...
    fn KillTimer(&self, nIDEvent: UINT_PTR) -> bool {
        self.assert_window();
        unsafe {
            user32::KillTimer(self.GetHwnd(), nIDEvent) == TRUE
        }
    }
    ...
    fn IsWindowEnabled(&self) -> bool {
        self.assert_window();
        unsafe {
            user32::IsWindowEnabled(self.GetHwnd()) == TRUE
        }
    }
    ...
    fn EnableWindow(&self, bEnable: BOOL) -> bool {
        self.assert_window();
        unsafe {
            user32::EnableWindow(self.GetHwnd(), bEnable) == TRUE
        }
    }
    ...
    fn SetActiveWindow(&self) -> HWND {
        self.assert_window();
        unsafe {
            user32::SetActiveWindow(self.GetHwnd())
        }
    }
    ...
    fn SetCapture(&self) -> HWND {
        self.assert_window();
        unsafe {
            user32::SetCapture(self.GetHwnd())
        }
    }
    ...
    fn CheckDlgButton(&self, nIDButton: c_int, nCheck: UINT) -> bool {
        self.assert_window();
        unsafe {
            user32::CheckDlgButton(self.GetHwnd(), nIDButton, nCheck) == TRUE
        }
    }

    fn CheckRadioButton(&self,
        ...
        self.assert_window();
        unsafe {
            user32::CheckRadioButton(self.GetHwnd(), nIDFirstButton, nIDLastButton, nIDCheckButton) == TRUE
        }
    }
    ...
    fn GetDlgItemInt(&self, nID: c_int) -> UINT {
        self.assert_window();
        unsafe {
            user32::GetDlgItemInt(self.GetHwnd(), nID, 0 as *mut BOOL, TRUE)
        }
    }
    ...
    fn GetDlgItemInt2(&self, nID: c_int, lpTrans: &mut BOOL, bSigned: BOOL) -> UINT {
        self.assert_window();
        unsafe {
            user32::GetDlgItemInt(self.GetHwnd(), nID, lpTrans as *mut BOOL, bSigned)
        }
    }
    ...
    fn IsDlgButtonChecked(&self, nIDButton: c_int) -> UINT {
        self.assert_window();
        unsafe {
            user32::IsDlgButtonChecked(self.GetHwnd(), nIDButton)
        }
    }

    fn SendDlgItemMessage(&self,
                              nID: c_int,
                              message: UINT,
                              wParam: WPARAM,
                              lParam: LPARAM)
        ...
        self.assert_window();
        unsafe {
            user32::SendDlgItemMessageW(self.GetHwnd(), nID, message, wParam, lParam)
        }
    }
    ...
    fn SetDlgItemInt(&self, nID: c_int, nValue: UINT, bSigned: BOOL) -> bool {
        self.assert_window();
        unsafe {
            user32::SetDlgItemInt(self.GetHwnd(), nID, nValue, bSigned) == TRUE
        }
    }
...
// #endif
    ...
    fn GetScrollPos(&self, nBar: c_int) -> c_int {
        self.assert_window();
        unsafe {
            user32::GetScrollPos(self.GetHwnd(), nBar)
        }
    }
    ...
    fn GetScrollRange(&self, nBar: c_int, lpMinPos: LPINT, lpMaxPos: LPINT) -> bool {
        self.assert_window();
        unsafe {
            user32::GetScrollRange(self.GetHwnd(), nBar, lpMinPos, lpMaxPos) == TRUE
        }
    }

    fn ScrollWindow(&self,
                        xAmount: c_int,
                        yAmount: c_int,
                        lpRect: LPCRECT,
                        lpClipRect: LPCRECT)
        ...
        self.assert_window();
        unsafe {
            user32::ScrollWindow(self.GetHwnd(), xAmount, yAmount, lpRect, lpClipRect) == TRUE
        }
    }
    ...
    fn ScrollWindowEx(&self,
        ...
        self.assert_window();
        unsafe {
            user32::ScrollWindowEx(self.GetHwnd(),
                                   dx,
                                   dy,
                                   lpRectScroll,
                                   lpRectClip,
    ...
    fn SetScrollPos(&self, nBar: c_int, nPos: c_int, bRedraw: BOOL) -> c_int {
        self.assert_window();
        unsafe {
            user32::SetScrollPos(self.GetHwnd(), nBar, nPos, bRedraw)
        }
    }
    ...
    fn SetScrollRange(&self,
        ...
        self.assert_window();
        unsafe {
            user32::SetScrollRange(self.GetHwnd(), nBar, nMinPos, nMaxPos, bRedraw) == TRUE
        }
    }
    ...
    fn ShowScrollBar(&self, nBar: c_int, bShow: BOOL) -> bool {
        self.assert_window();
        unsafe {
            user32::ShowScrollBar(self.GetHwnd(), nBar, bShow) == TRUE
        }
    }
    ...
    fn EnableScrollBar(&self, uSBFlags: UINT, uArrowFlags: UINT) -> bool {
        self.assert_window();
        unsafe {
            user32::EnableScrollBar(self.GetHwnd(), uSBFlags, uArrowFlags) == TRUE
        }
    }
    ...
    fn IsChild(&self, hWnd: HWND) -> bool {
        self.assert_window();
        unsafe {
            user32::IsChild(self.GetHwnd(), hWnd) == TRUE
        }
    }
    ...
    fn GetDlgCtrlID(&self) -> c_int {
        self.assert_window();
        unsafe {
            user32::GetDlgCtrlID(self.GetHwnd())
        }
    }
    ...
    fn SetDlgCtrlID(&self, nID: c_int) -> c_int {
        self.assert_window();
        unsafe {
            user32::SetWindowLongW(self.GetHwnd(), GWL_ID, nID)
        }
    }
    ...
    fn FlashWindow(&self, bInvert: BOOL) -> bool {
        self.assert_window();
        unsafe {
            user32::FlashWindow(self.GetHwnd(), bInvert) == TRUE
        }
    }
    ...
    fn ChangeClipboardChain(&self, hWndNewNext: HWND) -> bool {
        self.assert_window();
        unsafe {
            user32::ChangeClipboardChain(self.GetHwnd(), hWndNewNext) == TRUE
        }
    }
    ...
    fn SetClipboardViewer(&self) -> HWND {
        self.assert_window();
        unsafe {
            user32::SetClipboardViewer(self.GetHwnd())
        }
    }
    ...
    fn OpenClipboard(&self) -> bool {
        self.assert_window();
        unsafe {
            user32::OpenClipboard(self.GetHwnd()) == TRUE
        }
    }
    ...
    fn CreateCaret(&self, hBitmap: HBITMAP) -> bool {
        self.assert_window();
        unsafe {
            user32::CreateCaret(self.GetHwnd(), hBitmap, 0, 0) == TRUE
        }
    }
    ...
    fn CreateSolidCaret(&self, nWidth: c_int, nHeight: c_int) -> bool {
        self.assert_window();
        unsafe {
            user32::CreateCaret(self.GetHwnd(), 0 as HBITMAP, nWidth, nHeight) == TRUE
        }
    }
    ...
    fn CreateGrayCaret(&self, nWidth: c_int, nHeight: c_int) -> bool {
        self.assert_window();
        unsafe {
            user32::CreateCaret(self.GetHwnd(), 1 as HBITMAP, nWidth, nHeight) == TRUE
        }
    }
    ...
    fn HideCaret(&self) -> bool {
        self.assert_window();
        unsafe {
            user32::HideCaret(self.GetHwnd()) == TRUE
        }
    }
    ...
    fn ShowCaret(&self) -> bool {
        self.assert_window();
        unsafe {
            user32::ShowCaret(self.GetHwnd()) == TRUE
        }
    }
    ...
    fn SetIcon(&self, hIcon: HICON, bBigIcon: BOOL) -> HICON {
        self.assert_window();
        unsafe {
            user32::SendMessageW(self.GetHwnd(), WM_SETICON, bBigIcon as WPARAM, hIcon as LPARAM) as HICON
        }
    }
    ...
    fn GetIcon(&self, bBigIcon: BOOL) -> HICON {
        self.assert_window();
        unsafe {
            user32::SendMessageW(self.GetHwnd(), WM_GETICON, bBigIcon as WPARAM, NULL_LPARAM) as HICON
        }
    }
    ...
    fn SetWindowContextHelpId(&self, dwContextHelpId: DWORD) -> bool {
        self.assert_window();
        unsafe {
            user32::SetWindowContextHelpId(self.GetHwnd(), dwContextHelpId) == TRUE
        }
    }
    ...
    fn GetWindowContextHelpId(&self) -> DWORD {
        self.assert_window();
        unsafe {
            user32::GetWindowContextHelpId(self.GetHwnd())
        }
    }
    ...
    fn SetHotKey(&self, wVirtualKeyCode: WORD, wModifiers: WORD) -> c_int {
        self.assert_window();
        unsafe {
            user32::SendMessageW(self.GetHwnd(), WM_SETHOTKEY, MAKEWORD(wVirtualKeyCode as u8, wModifiers as u8) as WPARAM, 0 ) as c_int
        }
    }
    ...
    fn GetHotKey(&self) -> DWORD {
        self.assert_window();
        unsafe {
            user32::SendMessageW(self.GetHwnd(), WM_GETHOTKEY, 0, 0) as DWORD
        }
    }
    ...
    fn GetScrollInfo(&self, nBar: c_int, lpScrollInfo: LPSCROLLINFO) -> bool {
        self.assert_window();
        unsafe {
            user32::GetScrollInfo(self.GetHwnd(), nBar, lpScrollInfo) == TRUE
        }
    }
    fn SetScrollInfo(&self, nBar: c_int, lpScrollInfo: LPSCROLLINFO, bRedraw: BOOL) -> c_int {
        self.assert_window();
        unsafe {
            user32::SetScrollInfo(self.GetHwnd(), nBar, lpScrollInfo, bRedraw)
        }
    }
    fn IsDialogMessage(&self, lpMsg: LPMSG) -> bool {
        self.assert_window();
        unsafe {
            user32::IsDialogMessageW(self.GetHwnd(), lpMsg) == TRUE
        }
    }
    ...
    fn NextDlgCtrl(&self) {
        self.assert_window();
        unsafe {
            user32::SendMessageW(self.GetHwnd(), WM_NEXTDLGCTL, 0, 0);
        }
    }
    fn PrevDlgCtrl(&self) {
        self.assert_window();
        unsafe {
            user32::SendMessageW(self.GetHwnd(), WM_NEXTDLGCTL, 1, 0);
        }
    }
    fn GotoDlgCtrl(&self, hWndCtrl: HWND) {
        self.assert_window();
        unsafe {
            user32::SendMessageW(self.GetHwnd(), WM_NEXTDLGCTL, hWndCtrl as WPARAM, 1);
        }
    }
    ...
    fn GetWindowRgn(&self, hRgn: HRGN) -> c_int {
        self.assert_window();
        unsafe {
            user32::GetWindowRgn(self.GetHwnd(), hRgn)
        }
    }
    fn SetWindowRgn(&self, hRgn: HRGN, bRedraw: BOOL) -> c_int {
        self.assert_window();
        unsafe {
            user32::SetWindowRgn(self.GetHwnd(), hRgn, bRedraw)
        }
    }
    ...
    fn DeferWindowPos(&self,
        ...
        self.assert_window();
        unsafe {
            user32::DeferWindowPos(hWinPosInfo, self.GetHwnd(), hWndInsertAfter, x, y, cx, cy, uFlags)
        }
    }
    ...
    fn GetWindowThreadID(&self) -> DWORD {
        self.assert_window();
        unsafe {
            user32::GetWindowThreadProcessId(self.GetHwnd(), 0 as LPDWORD)
        }
    }
    ...
    fn GetWindowProcessID(&self) -> DWORD {
        ...
        unsafe {
            user32::GetWindowThreadProcessId(self.GetHwnd(), &mut dwProcessID);
        }
        dwProcessID
    }
    ...
    fn IsWindowUnicode(&self) -> bool {
        self.assert_window();
        unsafe {
            user32::IsWindowUnicode(self.GetHwnd()) == TRUE
        }
    }
    ...
    fn ShowWindowAsync(&self, nCmdShow: c_int) -> bool {
        self.assert_window();
        unsafe {
            user32::ShowWindowAsync(self.GetHwnd(), nCmdShow) == TRUE
        }
    }
    ...
    fn CenterWindow(&self, hCenter: HWND) -> BOOL {
        self.assert_window();
        ...
        unsafe {
            ...
            if hWndCenter == NULL_HWND {
                if dwStyle & WS_CHILD != 0 {
                    hWndCenter = self.GetParent2();//::GetParent(self.GetHwnd());
                } else {
                    hWndCenter = user32::GetWindow(self.GetHwnd(), GW_OWNER);
                }
            }


            let mut rcDlg: RECT = Default::default();
            user32::GetWindowRect(self.GetHwnd(), &mut rcDlg);
            ...
            if dwStyle & WS_CHILD == 0 {
                ...
                if hWndCenter != NULL_HWND {
                    ...
                    hMonitor = user32::MonitorFromWindow(self.GetHwnd(), MONITOR_DEFAULTTONEAREST);
                }
                ...
                hWndParent = user32::GetParent(self.GetHwnd());
    ...
    fn ModifyStyle(&self, dwRemove: DWORD, dwAdd: DWORD, nFlags: UINT) -> bool {
        ...
        unsafe {
            user32::SetWindowLongW(self.GetHwnd(), GWL_STYLE, dwNewStyle as LONG);
        }
        if nFlags != 0 {
            unsafe {
                user32::SetWindowPos(self.GetHwnd(),
    ...
    fn ModifyStyleEx(&self, dwRemove: DWORD, dwAdd: DWORD, nFlags: UINT) -> bool {
        ...
        unsafe {
            user32::SetWindowLongW(self.GetHwnd(), GWL_EXSTYLE, dwNewStyle as LONG);
        }
        if nFlags != 0 {
            unsafe {
                user32::SetWindowPos(self.GetHwnd(),
