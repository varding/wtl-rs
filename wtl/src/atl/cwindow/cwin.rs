...
impl CWindow {
	...
	pub fn SetRedraw (&self,bRedraw:BOOL)  {
		self.assert_window();
		unsafe{user32::SendMessageW(self.0, WM_SETREDRAW, bRedraw as WPARAM, NULL_LPARAM);}
	}
...
// #endif 
	...
	pub fn GetIcon (&self,bBigIcon:BOOL) -> HICON {
		self.assert_window();
		unsafe{user32::SendMessageW(self.0, WM_GETICON, bBigIcon as WPARAM, NULL_LPARAM) as HICON}
	}
